...
/**
 * The Card page model. When requesting a page from the Blizzard card search API past the last page that contains actual
...
public class CardPageModel {
     ...
     *
     * @param pageCount The page count for the card page model.
     */
     ...
     *
     * @param cardCount The card count for the card page model.s
     */
