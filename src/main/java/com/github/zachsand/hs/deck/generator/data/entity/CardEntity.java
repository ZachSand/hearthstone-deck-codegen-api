...
/**
 * The Card entity based on the Hearthstone API card search.
 *
...
public class CardEntity {
	...
	@ManyToMany
	private Set<ClassMetadataEntity> multiClassMetadata;
	 ...
	 *
	 * @param classId
	 *            The {@link ClassMetadataEntity} related to this card.
	 */
	public void setClassMetadata(final ClassMetadataEntity classId) {
		this.classMetadata = classId;
	}

	public Set<ClassMetadataEntity> getMultiClassMetadata() {
		return multiClassMetadata;
	}

	public void setMultiClassMetadata(Set<ClassMetadataEntity> multiClassMetadata) {
		this.multiClassMetadata = multiClassMetadata;
	}
	 ...
	 *
	 * @param cardTypeId
	 *            The {@link TypeMetadataEntity} related to this card.
	 */
	 ...
	 *
	 * @param cardSetId
	 *            The {@link SetMetadataEntity} related to this card.
	 */
